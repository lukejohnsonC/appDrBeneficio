...
<section id="agendar">
        <div class="container">
          ...
          <a href="https://api.whatsapp.com/send?phone=5513997748080" target='_blank'><i class="fab fa-whatsapp"></i><button class="pattern">WhatsApp</button> ou clique no botão laranja</a><br>
