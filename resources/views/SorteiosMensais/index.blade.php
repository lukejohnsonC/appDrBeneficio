...
<section id="funeral">
	<div class="container">
		...
		<ol id="steps">
			<li><p><i class="fas fa-pen-fancy"></i> Ao se tornar um Cliente DR. BENEFÍCIO, todo titular ganha um número de Titulo De Captalização</p></li>
